...
Etonify развивается как независимый проект с открытым исходным кодом. Если вам нравится приложение, вы можете [поддержать разработчика материально через Tribute](https://t.me/tribute/app?startapp=dQAQ). Мне будет приятно, а ваша поддержка помогает продолжать работу над проектом.
