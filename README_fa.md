...
Etonify یک پروژهٔ متن‌باز و مستقل است. اگر از این برنامه خوشتان می‌آید، می‌توانید از طریق [Tribute به‌صورت مالی از توسعه‌دهنده حمایت کنید](https://t.me/tribute/app?startapp=dQAQ). این حمایت برای من دلگرم‌کننده است و کمک می‌کند کار روی پروژه را ادامه دهم.
