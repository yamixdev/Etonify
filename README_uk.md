...
Etonify розвивається як незалежний проєкт із відкритим кодом. Якщо вам подобається застосунок, ви можете [матеріально підтримати розробника через Tribute](https://t.me/tribute/app?startapp=dQAQ). Мені буде приємно, а ваша підтримка допомагає продовжувати роботу над проєктом.
